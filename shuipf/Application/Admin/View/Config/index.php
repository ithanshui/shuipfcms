...
<div class="wrap J_check_wrap">
    ...
    <form method='post'   id="myform" class="J_ajaxForm"  action="{:U('Config/index')}">
      ...
      <tr>
	     <th width="140">网站版权:</th>
	     <td><input type="text" class="input"  name="copyright" value="{$Site.copyright}" size="72"> </td>
      </tr>
      <tr>
	     <th width="140">CNZZ:</th>
	     <td><textarea name="sitecnzz" style="width:380px; height:150px;">{$Site.sitecnzz}</textarea> </td>
      </tr>
      <tr>
